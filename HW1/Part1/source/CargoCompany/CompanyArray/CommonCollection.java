package CargoCompany.CompanyArray;
...
public abstract class CommonCollection<T>  extends GTUContainer<T> {
    ...
    /**
     * Return the actual array type of the element.
     * @param index index code that will be returned.
     * */
    public T getArrayIndex( int index ) throws IndexOutOfBoundsException{
     ...
     */
    @SuppressWarnings("unchecked")
    protected CommonCollection( int initialCapacity ) {
